...
def apply_mask(pr_cube, sftlf_file, realm):
    """Apply a land or ocean mask to our plot"""
    ...
    pr_cube.data = numpy.ma.asarray(cube.data)
...
def main(inargs):
    ...
    if inargs.mask:
        sftlf_file = inargs.sftlf_file, realm = inargs.mask
